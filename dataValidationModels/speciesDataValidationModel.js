db.runCommand({collMod: "species",
                 ...
                 [
                   ...
                   {$or: [
                       {$and:[{bmClass: {"$type": "string"}}, {bmClass: {"$in": ["Plantas", "Invertebrados", "Aves", "Peces", "Reptiles", "Mamiferos", "Anfibios"]}}]}, 
                       {bmClass: {"$type": "null"}}
                         ]},
                   {$or: [
                       {$and:[{cites: {"$type": "string"}}, {cites: {"$in": ["I", "II", "III", "NC", "III/NC", "I/NC", "I/II", "I/III", "II/NC", "I/II/III/NC", "I/II/NC"]}}]}, 
                       {cites: {"$type": "null"}}
                         ]},
                   {$or: [{taxonomicStatus: {"$type": "string"}}, {taxonomicStatus: {"$type": "null"}}]},
                   {$or: [{scientificNameAuthorship: {"$type": "string"}}, {scientificNameAuthorship: {"$type": "null"}}]},
                   {$or: [{specificEpithet: {"$type": "string"}}, {specificEpithet: {"$type": "null"}}]},
                   {$or: [{nameAccordingTo: {"$type": "string"}}, {nameAccordingTo: {"$type": "null"}}]},
                   {$or: [{TaxVerifSource: {"$type": "string"}}, {TaxVerifSource: {"$type": "null"}}]},
                   {$or: [{nameAccordingTo: {"$type": "string"}}, {nameAccordingTo: {"$type": "null"}}]},
                   ...
                   {$or: [
                       {$and:[{iucn: {"$type": "string"}}, {iucn: {"$in": ["EX", "EW", "CR", "EN", "VU", "NT", "LC", "DD", "NE"]}}]}, 
                       {iucn: {"$type": "null"}}
                         ]},
