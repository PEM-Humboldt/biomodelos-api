db.runCommand({
  ...
  validator: {
    $and: [
      ...
      {
        $or: [{ url: { $type: 'string' } }, { url: { $type: 'null' } }]
      },
      {
        $or: [
      ...
      {
        $or: [{ created: { $type: 'object' } }, { created: { $type: 'null' } }]
      },
      {
        $or: [{ updated: { $type: 'object' } }, { updated: { $type: 'null' } }]
      },
      {
        $or: [
      ...
      {
        $or: [{ source: { $type: 'string' } }, { source: { $type: 'null' } }]
      },
      {
        $or: [
      ...
      {
        $or: [{ override: { $type: 'bool' } }, { override: { $type: 'null' } }]
      },
      {
        $or: [
      ...
      {
        $or: [{ use: { $type: 'bool' } }, { use: { $type: 'null' } }]
      },
