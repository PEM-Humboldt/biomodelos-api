db.runCommand({
  ...
  validator: {
    $and: [
      ...
      {
        $or: [{ isActive: { $type: 'bool' } }, { isActive: { $type: 'null' } }]
      },
      {
        $or: [{ modelID: { $type: 'number' } }, { modelID: { $type: 'null' } }]
      },
      ...
      {
        $or: [{ pValue: { $type: 'number' } }, { pValue: { $type: 'null' } }]
      },
      {
        $or: [
      ...
      },
      {
        $or: [
          ...
          { statRepPA1: { $type: 'null' } }
        ]
      },
      {
        $or: [
          { statRepPA2: { $type: 'number' } },
          { statRepPA2: { $type: 'null' } }
        ]
      },
      {
        $or: [
          { statRepPA3: { $type: 'number' } },
          { statRepPA3: { $type: 'null' } }
        ]
      },
